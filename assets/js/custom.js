...
$('.owl-banner').owlCarousel({
  ...
  smartSpeed: 900,            // smooth sliding speed
  autoplaySpeed: 900,         // smooth autoplay slide
  dragEndSpeed: 700,          // smooth touch release
  easing: "cubic-bezier(0.25, 0.46, 0.45, 0.94)", // smartphone-style easing
  nav: true,
  dots: false,
  navText: [
